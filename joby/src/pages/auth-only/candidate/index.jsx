...
import CandidateProfilePageSocials from './candidate-profile-page-socials';
import CandidateProfilePageUser from './candidate-profile-page-user';
import CandidateProfilePageUserDescription from './candidate-profile-page-user-description';
import CandidateProfilePageImage from './candidate-profile-page-image';
      ...
      <SecondaryContentContainer>
        <Grid container spacing={1}>
          <Grid
            ...
            md={4.7}
            sx={{
              display: { xs: 'flex', md: 'block', lg: 'block' }, alignItems: 'center', flexDirection: 'column',
            }}
          >
          ...
          <Grid item xs={12} md={7} sx={{ mx: 'auto' }}>
            <CandidateProfilePageUser
              user={user}
              submiting={submiting}
              setSubmiting={setSubmiting}
              setInfoSnackbar={setInfoSnackbar}
            />
            <CandidateProfilePageUserDescription
              user={user}
              submiting={submiting}
              setSubmiting={setSubmiting}
              setInfoSnackbar={setInfoSnackbar}
